...
3. Какое максимальное количество спикеров ожидается
...
1) Первый контакт - решение организационных вопросов. Если организаторы дают на тему выступления зелёный свет - задание тона и формы всей презентации.
...
#### Информация о выступлении и зелёный свет
1. Попросить у спикера развёрнутое описание того, о чём пойдёт речь в выступлении.
2. Передать эту информацию и личные соображения организаторам.
3. Если организаторы принимают решение взять спикера:
    1. Сразу попросить спикера сформулировать название выступления (желательно немного кликбейтное) и скинуть вам свою фотографию
    2. Передать название и фото организаторам - это нужно для подготовки афиши
3. Если организаторы не уверены, стоит ли брать этого спикера:
    1. Попросить у оранизаторов дедлайн (минимум две недели до конференции) для решения
    2. Сообщить о дедлайне спикеру и сказать, что вы будете держать в курсе
    3. Вернуться в обозначенную дату к спикеру
4. Если организаторы решили не брать этого спикера:
    1. Аккуратно сообщить спикеру причину. Сказать, что на эту конференцию все слоты уже заполнены.
    2. Если сам спикер хороший и тема интересная - предложить занести его в первую очередь на следующую конференцию с этой темой
    3. Если тема полностью не подходит, а со спикером дисконнект - просто вежливо попрощаться 
...
1) Заранее обговорите форму и дату сдачи первой версии. После получения фидбека первой итерации у спикера должно быть не менее недели до выступления - не оставляйте ничего на последний момент. Самая удобная форма для ревью - скринкаст. Альтернативно можно просто созвониться. 
...
## Частые кейсы в ревью
### Спикер уверен, что публика владеет определённым специфическим контекстом
Люди с большим рабочим опытом могут иметь определённый bias.
Ситуация, где спикер предполагает у аудитории наличие определённых знаний, случается в половине случаев.
Помните, что на конференции могут быть слушатели из самых далёких кусочков айти, или люди вообще не из айти.
То, что тривиально и понятно для фронтендера, может быть абсолютно непонятно для бэкендеров или для людей вне веба.

Задача спикера - интерактивно понять аудиторию и найти баланс между докладом "для специалиста" и докладом для "человека полностью вне контекста".

### Спикер подаёт материал, но не раскрывает самые интересные вопросы для людей со стороны
Поставьте себя на место человека, пришедшего на конференцию. Вы увидели название выступления в афише, и подумали - "Ага, вот там точно расскажут про X и Z!"
Вы видите хорошие слайды, слышите хороший рассказ, но удивляетесь, что темы, которые вы точно ожидали увидеть в выступлении, даже не были затронуты.

Сообщите об этом спикеру. Возможно, он сознательно решил оставить эти вещи для дискуссии. А может быть, даже и не задумывался об этом.

### Спикер даёт слишком общий материал, мало конкретики
Вы посмотрели материал, и поняли, что вынесли для себя очень мало из выступления. 
Возможно, спикер озвучивал абстрактные материи, но не привёл примеров?
Или спикер давал общие рекомендации, и абсолютно непонятно, как их применять?

Попросите спикера подкрепить материал примерами или глубже раскрыть "слишком общие" части выступления.
